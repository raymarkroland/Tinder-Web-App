 var Resample = (function (canvas) {
    ...
    var newCropWidth = 150;
    var newCropHeight = 150;

    function loadImage(data) {
      document.querySelector('#imgDisplay').src = data;
      document.querySelector('#abc').src = data;
    }
    ...
    document.querySelector('#uploadimg').addEventListener('change', handleFileSelect, false);
